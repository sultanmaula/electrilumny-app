...
public class User_Event extends AppCompatActivity {
    ...
    RecyclerAdapterEvent_User adapter;
    ArrayList<ListDataEvent> arrayList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new RecyclerAdapterEvent_User(arrayList);
        recyclerView.setAdapter(adapter);
        progressDialog = new ProgressDialog(User_Event.this);
        ...
        if(checkNetworkConnection()){
            ...
            try {
                ...
                while (countData < serverResponse.length()){
                    ...
                    arrayList.add(new ListDataEvent(nama_event, deskripsi_event, tgl_event, lokasi_event));
                    countData++;
                }
                countData = 0;
